...
async function selectPlatform() {
    ...
    log('\n📋 支持的部署平台:', 'yellow');
    log('1. 🌟 Vercel (推荐 - 零配置，全球 CDN)', 'green');
    log('2. 🚄 Railway (优秀开发体验，内置数据库)', 'green');
    log('3. 🌊 Netlify (函数 + 静态站点)', 'green');
    log('4. 🐳 Docker (本地构建镜像)', 'green');
    log('5. 📖 仅显示部署指南', 'blue');
...
async function showDeploymentGuide() {
    ...
    log('\n📊 平台对比:', 'yellow');
    log('┌─────────┬──────────┬─────────┬─────────┐', 'cyan');
    log('│ 平台    │ 免费额度 │ 数据库  │ 难度    │', 'cyan');
    log('├─────────┼──────────┼─────────┼─────────┤', 'cyan');
    log('│ Vercel  │ 100GB/月 │ 需外部  │ ⭐      │', 'white');
    log('│ Railway │ $5/月    │ 内置    │ ⭐⭐    │', 'white');
    log('│ Netlify │ 100GB/月 │ 需外部  │ ⭐⭐    │', 'white');
    log('└─────────┴──────────┴─────────┴─────────┘', 'cyan');
